...
//        s.classNames.push('swiper-container-' + s.params.direction);
        s.classNames.push(s.params.direction === 'horizontal' ? 'swiper-container-horizontal' : 'swiper-container-vertical' );
...
//            (s.params.touchEventsTarget === 'container' ? s.container : s.wrapper).addClass('swiper-wp8-' + s.params.direction);
            (s.params.touchEventsTarget === 'container' ? s.container : s.wrapper).addClass(s.params.direction === 'horizontal' ? 'swiper-wp8-horizontal' : 'swiper-wp8-vertical');
        }
